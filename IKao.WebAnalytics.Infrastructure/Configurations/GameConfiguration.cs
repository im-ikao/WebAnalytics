...
public class GameConfiguration : IEntityTypeConfiguration<Game>
{
    public void Configure(EntityTypeBuilder<Game> builder)
    {
        ...
        builder
            .HasMany(e => e.RelationLanguages)
            .WithMany(e => e.RelationGames)
            .UsingEntity<GameLanguageRelation>(l =>
                {
                    return l.HasOne<Language>()
                        .WithMany()
                        .HasForeignKey(x => x.LanguageId);
                },
                r =>
                {
                    return r.HasOne<Game>()
                        .WithMany()
                        .HasForeignKey(x => x.GameId);
                },
                j =>
                {
                    j.ToTable("game_languages");
                    
                    j.Property(x => x.LanguageId)
                        .HasColumnName("language_id");

                    j.Property(x => x.GameId)
                        .HasColumnName("game_id");
                }
            );
        
        builder
            .HasMany(e => e.RelationCategories)
            .WithMany(e => e.RelationGames)
            .UsingEntity<GameCategoryRelation>(l =>
                {
                    return l.HasOne<Category>()
                        .WithMany()
        ...
        builder
            .HasMany(e => e.RelationTags)
            .WithMany(e => e.RelationGames)
            .UsingEntity<GameTagRelation>(l =>
                {
                    return l.HasOne<Tag>()
                            .WithMany()
